...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tao-theme org-table-sticky-header org-bullets dired+ zop-to-char zeal-at-point wttrin writeroom-mode worf which-key wgrep web-mode volatile-highlights visual-regexp-steroids use-package-chords undo-tree twittering-mode tomatinho tabbar-ruler symon swap-regions srefactor spacemacs-theme spaceline smex simple+ shm shift-number rg restart-emacs replace+ rainbow-delimiters racket-mode projectile-speedbar projectile-ripgrep pp+ plantuml-mode parinfer package-utils org-pomodoro multiple-cursors move-dup mouse+ menu-bar+ meghanada markdown-mode major-mode-icons magit litable lispy lfe-mode langtool lacarte jdee java-snippets ivy-rich ivy-hydra isearch-prop isearch+ irony-eldoc intero info+ imenu+ icomplete+ icicles hlint-refactor hl-line+ highlight-thing highlight haskell-snippets guess-language google-translate google-this golden-ratio git-timemachine git-gutter-fringe general function-args focus flyspell-popup flyspell-correct-ivy flycheck-pos-tip flycheck-package flycheck-irony flycheck-haskell face-remap+ exec-path-from-shell esup ess eshell-fringe-status erefactor engine-mode emr emojify emmet-mode embrace elfeed electric-spacing dumb-jump dr-racket-like-unicode dashboard counsel-projectile counsel-dash company-web company-statistics company-quickhelp company-irony-c-headers company-irony company-ghci company-ghc company-dict company-cabal ciel cider centered-cursor-mode buffer-move bookmark+ beacon auto-yasnippet anzu all-the-icons-dired))))
