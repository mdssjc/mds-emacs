...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-table-sticky-header org-table-sticky-header-mode symon icomplete+ face-remap+ company-emacs-eclim zeal-at-point wttrin writeroom-mode worf which-key web-mode volatile-highlights use-package-chords undo-tree twittering-mode tomatinho tabbar-ruler swap-regions srefactor spacemacs-theme spaceline smex simple+ shm restart-emacs replace+ rainbow-delimiters racket-mode projectile-speedbar projectile-ripgrep pp+ plantuml-mode parinfer package-utils org-pomodoro org-bullets move-dup mouse+ menu-bar+ meghanada markdown-mode major-mode-icons magit litable lispy lfe-mode langtool jdee java-snippets ivy-rich ivy-hydra isearch-prop isearch+ irony-eldoc intero info+ imenu+ icicles hlint-refactor hl-line+ highlight-thing highlight haskell-snippets guess-language golden-ratio git-timemachine git-gutter-fringe general function-args focus flyspell-popup flyspell-correct-ivy flycheck-pos-tip flycheck-package flycheck-irony flycheck-haskell exec-path-from-shell esup ess eshell-fringe-status erefactor engine-mode emr emojify emmet-mode embrace elfeed electric-spacing eclim dumb-jump dr-racket-like-unicode dired+ dashboard counsel-projectile counsel-dash company-web company-statistics company-quickhelp company-irony-c-headers company-irony company-ghci company-ghc company-dict company-cabal ciel cider centered-cursor-mode buffer-move bookmark+ beacon auto-yasnippet anzu all-the-icons-dired))))
