...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (clojure-snippets zop-to-char zeal-at-point wttrin writeroom-mode worf which-key wgrep web-mode volatile-highlights visual-regexp-steroids use-package undo-tree twittering-mode tomatinho tao-theme tabbar-ruler symon swap-regions srefactor sqlup-mode sql-indent spaceline-all-the-icons smex simple+ shm shift-number rg restart-emacs replace+ rainbow-delimiters racket-mode projectile-speedbar projectile-ripgrep pp+ popup-imenu popup-edit-menu plantuml-mode parinfer package-utils org-table-sticky-header org-sticky-header org-pomodoro org-bullets nlinum move-dup mouse+ menu-bar+ meghanada markdown-mode magit litable lispy lfe-mode langtool lacarte jdee java-snippets ivy-rich ivy-hydra isearch-prop isearch+ irony-eldoc intero info+ imenu+ icomplete+ icicles hlint-refactor hl-line+ highlight-thing haskell-snippets guess-language google-translate google-this golden-ratio gitignore-mode git-timemachine git-gutter-fringe general function-args focus flyspell-popup flyspell-correct-ivy flycheck-pos-tip flycheck-package flycheck-irony flycheck-haskell face-remap+ exec-path-from-shell esup ess eshell-fringe-status erefactor engine-mode emr emojify emmet-mode embrace elfeed electric-spacing ejc-sql dumb-jump dr-racket-like-unicode doremi dired+ dashboard counsel-projectile counsel-dash company-web company-statistics company-quickhelp company-irony-c-headers company-irony company-ghci company-ghc company-dict company-cabal color-identifiers-mode clj-refactor ciel cider-eval-sexp-fu centered-cursor-mode buffer-move bookmark+ auto-yasnippet anzu all-the-icons-dired))))
